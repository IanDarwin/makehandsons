...
Note that the program is not limited to working on Java programs; it could be
used on any programming languages or, indeed, on anything that is text based
...
Lines of code can be left in the student version but commented out, using //C+ and //C-
